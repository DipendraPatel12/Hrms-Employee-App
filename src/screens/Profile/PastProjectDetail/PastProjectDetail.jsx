    ...
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.contentContainer} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.topBanner}>
          ...
          <Text style={styles.bannerTitle}>King Salman Park</Text>
        ...
        <View style={styles.twoColContainer}>
          <View style={styles.colCard}>
            ...
            <Text style={styles.infoValue}>Jan 12, 2022</Text>
          </View>
          <View style={styles.colCard}>
            <Text style={styles.infoLabel}>End Date</Text>
            <Text style={styles.infoValue}>Mar 04, 2023</Text>
          </View>
        </View>

        <View style={[styles.colCard, { width: '100%', marginBottom: rh(1.5) }]}>
...
const styles = StyleSheet.create({
  ...
  completeBadge: {
    backgroundColor: '#22C55E', // Green bg
